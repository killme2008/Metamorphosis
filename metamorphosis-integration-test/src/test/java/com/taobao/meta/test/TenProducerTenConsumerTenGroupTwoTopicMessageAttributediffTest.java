...
/**
 * meta集成测试_TenProducerTenConsumerTenGroupTwoTopicMessageAttributediff
 * 
 * @author gongyangyu(gongyangyu@taobao.com)
 * 
 */

public class TenProducerTenConsumerTenGroupTwoTopicMessageAttributediffTest
		extends BaseMetaTest {
	...
	public void sendConsume() throws Exception {
		...
		try {
			...
			sendMessage_nProducer_twoTopic(count, "hello", this.topic1,
					this.topic2, 10, true,"langneng","gongyangyu");
